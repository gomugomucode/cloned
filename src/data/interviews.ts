...
export const interviewCategories: InterviewCategory[] = [
  {
    ...
    questions: [
      ...
      { id: 'q5', question: 'Explain Prototypal Inheritance.', answer: 'In JS, objects inherit properties from other objects via a prototype chain. Every object has a hidden internal property called [[Prototype]] that points to another object. If a property isn't found on the object, JS looks up the prototype chain until it finds it or hits null.', difficulty: 'Hard', category: 'OOP', tags: ['Prototypes', 'Inheritance'] },
