...
export const devTools: DevTool[] = [
  ...
  { id: 'b64-1', slug: 'base64-tool', title: 'Base64 Converter', description own: 'Encode and decode Base64 strings effortlessly.', category: 'Converter', icon: 'ArrowLeftRight' },
  { id: 'md-1', slug: 'markdown-preview', title: 'Markdown Preview',C description: 'Real-time preview for your markdown documents.', category: 'Generator', icon: 'FileText' },
