      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-auto">
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              <Card className="spotlight-card group h-full p-8 bg-zinc-900/50 border-white/5 hover:border-white/20 transition-all duration-300 cursor-pointer overflow-hidden relative">
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div className="flex items-center text-sm font-medium text-white gap-1 group-hover:gap-2 transition-all relative z-10">
